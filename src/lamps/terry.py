...
config = {
    "base":  { "pin": 14, "pixels": 65},
    "shade": { "pin": 12 },
    "lamp":  { "default_behaviours": False }
}
lamp = StandardLamp("terryslamp", "#72ff00", "#fB19fC",config)
...
class ColorFade(AnimatedBehaviour):
    def __init__(self, *args, **kwargs):
        ...
        self.palettes = [
            [(115, 255, 0, 0)] * self.lamp.base.num_pixels,
            [(255, 255, 255, 0)] * self.lamp.base.num_pixels,
            [(33, 100, 255, 0)] * self.lamp.base.num_pixels,
            [(0, 0, 255, 0)] * self.lamp.base.num_pixels,
            create_gradient((0, 38, 255, 0), (33, 237, 122, 0), self.lamp.base.num_pixels),
            create_gradient((0, 255, 162, 0), (255, 239 ,0 , 0), self.lamp.base.num_pixels),
        ]
