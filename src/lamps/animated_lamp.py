...
animated_lamp.shade.default_pixels = create_gradient((233, 70, 0, 0), (250, 0, 0, 0), animated_lamp.shade.num_pixels)
animated_lamp.add_behaviour(LampFadeIn(animated_lamp, frames=30, chained_behaviors=[WarpDrive, WarningLights]))
animated_lamp.add_behaviour(WarpDrive(animated_lamp, frames=3000))
