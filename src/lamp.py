from led_strip_rgb import LedStripRGB
...
class Lamp:
    def __init__(self, name, base_color, shade_color, config = default_config):
        ...
        self.name = name
        self.behaviours = []
        self.shade = LedStripRGB(self, shade_color, config['shade']['pin'], config['shade']['pixels'])
        self.base = LedStripRGB(self, base_color, config['base']['pin'], config['base']['pixels'])
